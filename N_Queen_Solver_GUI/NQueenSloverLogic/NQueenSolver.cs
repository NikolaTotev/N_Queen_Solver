...
namespace N_Queen_Solver_GUI.NQueenSloverLogic
{
    class NQueenSolver
    {
        ...
        public TimeSpan InitTime = new TimeSpan();
        public TimeSpan SolveTime = new TimeSpan();
        ...
        public async Task<bool> Initialize(InitMode mode)
        {
